...
export const SEARCH_TERMS: SearchTerm[] = [
  ...
  { term: "hyper mesh bra", count: 5, matched: true },
  { term: "sports bra", count: 7, matched: true },
  { term: "black leggings", count: 6, matched: true },
  { term: "co-ord set", count: 4, matched: false },
